 ...
 * @author Terry
 */
public interface DataResolutionService {

    List getMyTransactionsList(String id,String userLoginId,String isSupplier,String search, String company,int start,int limit,String sidx,String sord,String type) throws SQLException;
    int getMyTransactionsListCount(String id,String userLoginId,String isSupplier,String search,String company,String type) throws SQLException;
    ...
    public void assignPartnersToUser(String loginId, int userId, String moreTabs, String existingTabs,ArrayList partners,List assignedPartners) throws SQLException;
