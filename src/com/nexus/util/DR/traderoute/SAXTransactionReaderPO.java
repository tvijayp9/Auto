 ...
 *
 * @version $Id: SAXTransactionReaderPO.java,v 1.1.1.1 2003/09/03 05:25:33 oscarp Exp $
 */
public class SAXTransactionReaderPO extends DefaultHandler implements LexicalHandler
{
    Logger log=Logger.getLogger(SAXTransactionReaderPO.class);
    ...
    boolean BuyerOrderNumber_Done = false;
    ...
    public void startElement(String uri, String local, String raw, Attributes attrs) throws SAXException
    {
        ...
        && BuyerOrderNumber_Done && GeneralNote_Done)
        {
    ...
    {        
        ...
        if (currElementName.equalsIgnoreCase("BuyerOrderNumber"))
        {
            if (!BuyerOrderNumber_Done)
            {
                String val = getStringValue(ch, start);
...
//            se.printStackTrace();
    ...
    {        
        SAXTransactionReaderPO w = new SAXTransactionReaderPO();
        w.initialise();
        
        java.io.File dir = new java.io.File("C:\\TradeRoute\\TRANSACTIONS\\traderoute_queue\\Purchase_Orders");
