 ...
 * @author Terry
 */
public class AddShoppingCartItemAction extends ActionSupport {
    ...
    public String execute() throws SQLException{
        ...
        catalogueService.addShoppingCartItem(new Integer(id).intValue(), new Integer(supplierId).intValue(),productCode, sci,product_table_name);
        return SUCCESS;
    }
