 ...
 * @author Terry
 */
public class ShowSupplierProductsByCategoryAction extends ActionSupport {

    Logger log=Logger.getLogger(ShowSupplierProductsByCategoryAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        log.info("id..."+id+"..supplierId.in.ShowSupplierProductsByCategoryAction."+supplierId+"....product_table_name...."+product_table_name);
        count = catalogueService.getSupplierProductsByCategoryIdCount(searchFor,searchIn,product_table_name);
        if (count > 0) {
        ...
        if (start >= 0) {
            result = catalogueService.getSupplierProductsByCategoryId(new Integer(id).intValue(),new Integer(supplierId).intValue(), searchFor,searchIn,start, rows, sidx, sord,product_table_name);
        } else {
