 ...
 * @author Terry
 */
public class ShowTransactionListDetailsAction extends ActionSupport implements ServletRequestAware{

    Logger log=Logger.getLogger(ShowTransactionListDetailsAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
        ...
        if (start >= 0) {
           // if(type.equals("1")){
             //   log.info("getting Transactions");
                result = dataResolutionService.getMyTransactionsList(id,userloginId,isSupplier, _search, transactionnumber, start, rows, sidx, sord,type);
//            }
//            else{
//                log.info("getting Accepted/Rejected Transactions");
//                result = dataResolutionService.getMyTransactionsList(id,userloginId,isSupplier, _search, transactionnumber, start, rows, sidx, sord,type);
