 ...
 * @author Sunil
 */
public class ShowArchivedOrderListDetailsAction extends ActionSupport {

    Logger log=Logger.getLogger(ShowArchivedOrderListDetailsAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        log.info(" ID = " + id);
        log.info(" sup ID = " + id);
        count = catalogueService.getArchivedOrderListCount(id, supId, _search, orderno, order_date,order_date1);
        if (count > 0) {
        ...
        if (start >= 0) {
            result = catalogueService.getArchivedOrderList(id, supId, _search, orderno, order_date,order_date1, start, rows, sidx, sord);
        } else {
