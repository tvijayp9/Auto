 ...
 * @author Sunil
 */
public class ShowInBoundArchivedListDetailsAction extends ActionSupport {
...
//        System.out.println("dt1_received "+dt1_received);

        count = transactionService.getInBoundArchivedMessageListCount(id, _search, vch_document_id, company, dt_received,dt1_received);
        if (count > 0) {
        ...
        if (start >= 0) {
            result = transactionService.getInBoundArchivedMessageList(id, _search, vch_document_id, company, dt_received,dt1_received, start, rows, sidx, sord);
        } else {
