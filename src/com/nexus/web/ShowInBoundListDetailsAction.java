 ...
 * @author Terry
 */
public class ShowInBoundListDetailsAction extends ActionSupport {

    Logger log=Logger.getLogger(ShowInBoundListDetailsAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        count = transactionService.getInBoundMessageListCount(id, _search, vch_document_id, company, dt_received,dt1_received);
        ...
        if (start >= 0) {
            result = transactionService.getInBoundMessageList(id, _search, vch_document_id, company, dt_received,dt1_received, start, rows, sidx, sord);
        } else {
