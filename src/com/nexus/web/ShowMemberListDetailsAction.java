 ...
 * @author Terry
 */
public class ShowMemberListDetailsAction extends ActionSupport {
    ...
    public String execute() throws SQLException {
        ...
        count = tradingPartnerService.getMembersListCount(id, _search, company);
        if (count > 0) {
        ...
        if (start >= 0) {
            result = tradingPartnerService.getMembersList(id, _search, company, start, rows, sidx, sord);
        } else {
