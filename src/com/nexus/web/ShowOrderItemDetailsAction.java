 ...
 * @author Terry
 */
public class ShowOrderItemDetailsAction extends ActionSupport {
    ...
    public String execute() throws SQLException {
        count = catalogueService.getOrderItemsCount(orderId);
        if (count > 0) {
        ...
        result=catalogueService.getOrderItems(orderId, start, rows, sidx, sord);
        return SUCCESS;
    }
