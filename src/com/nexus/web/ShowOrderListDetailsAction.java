 ...
 * @author Terry
 */
public class ShowOrderListDetailsAction extends ActionSupport {

    Logger log=Logger.getLogger(ShowOrderListDetailsAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        log.info("id.."+id+"..supId.."+supId+".._search.."+_search+".orderno.."+orderno+"..order_date.."+order_date+"..order_date1.."+order_date1);
        count = catalogueService.getOrderListCount(id, supId, _search, orderno,order_date,order_date1);
        ...
        if (start >= 0) {
            result = catalogueService.getOrderList(id, supId, _search, orderno,order_date,order_date1,start, rows, sidx, sord);
        } else {
