 ...
 * @author Sunil
 */
public class ShowOutBoundArchivedListDetailsAction extends ActionSupport {

    Logger log=Logger.getLogger(ShowOutBoundArchivedListDetailsAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        log.info("id " + id);
        count = transactionService.getOutBoundArchivedMessageListCount(id, _search, vch_document_id, company, dt_received,dt1_received);
        ...
        if (start >= 0) {
            result = transactionService.getOutBoundArchivedMessageList(id, _search, vch_document_id, company, dt_received,dt1_received, start, rows, sidx, sord);
        } else {
