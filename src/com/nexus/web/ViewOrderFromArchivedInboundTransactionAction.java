 ...
 * @author Terry
 */
public class ViewOrderFromArchivedInboundTransactionAction extends ActionSupport {
    ...
    public String execute() throws SQLException, ParseException {
        PurchaseOrder po = transactionService.getPurchaseOrderFromArchivedInboundTransaction(messageId);
        if (po != null) {
