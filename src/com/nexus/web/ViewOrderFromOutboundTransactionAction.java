 ...
 * @author Terry
 */
public class ViewOrderFromOutboundTransactionAction extends ActionSupport {
    ...
    public String execute() throws SQLException, ParseException {
        PurchaseOrder po = transactionService.getPurchaseOrderFromOutboundTransaction(messageId);
        if (po != null) {
