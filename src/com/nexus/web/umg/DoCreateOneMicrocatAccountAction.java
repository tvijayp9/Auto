 ...
 * @author Terry
 */
public class DoCreateOneMicrocatAccountAction extends ActionSupport{
    ...
    public String execute() throws SQLException {
        tradingPartnerService.createMicrocatAccount(nexusId, microcatAccountNumber, microcatUsername, microcatPassword);
        return SUCCESS;
    }
