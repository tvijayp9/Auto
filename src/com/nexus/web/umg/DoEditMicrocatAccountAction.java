 ...
 * @author Terry
 */
public class DoEditMicrocatAccountAction extends ActionSupport{
    ...
    public String execute() throws SQLException {
        tradingPartnerService.updateMicrocatAccount(accountId, microcatAccountNumber, microcatUsername, microcatPassword, status);
        return SUCCESS;
    }
