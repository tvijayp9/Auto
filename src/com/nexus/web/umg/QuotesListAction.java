 ...
 * @author Terry
 */
public class QuotesListAction extends ActionSupport {

    Logger log=Logger.getLogger(QuotesListAction.class);
    ...
    public String execute() throws SQLException{
        ...
        count = catalogueService.getQuotesListCount(new Integer(id).intValue(),new Integer(supplierId).intValue());
        if (count > 0) {
        ...
        if (start >= 0) {
            setResult(catalogueService.getQuotesList(new Integer(id).intValue(),new Integer(supplierId).intValue(), start, rows, sidx, sord));
        } else {
