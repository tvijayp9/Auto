 ...
 * @author Terry
 */
public class ShowAmcapQuoteAction extends ActionSupport {
     private Logger log=Logger.getLogger(ShowAmcapQuoteAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        if (start >= 0) {
             log.info("start>=0");
            result = productManagementService.getQuote(toi, start, rows);
        } else {
