 ...
 * @author Terry
 */
public class ShowPartnerPriceTypeAction extends ActionSupport{

    Logger log=Logger.getLogger(ShowPartnerPriceTypeAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
       ActionContext ac = ActionContext.getContext();
        ...
        count = tradingPartnerService.getMyPartnersListCount(new Integer(id).intValue());
        ...
        if (start >= 0) {
            result = tradingPartnerService.getMyPartnersList(new Integer(id).intValue(), start, rows, sidx, sord);
        } else {
