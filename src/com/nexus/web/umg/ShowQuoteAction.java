 ...
 * @author Terry
 */
public class ShowQuoteAction extends ActionSupport {
     private Logger log=Logger.getLogger(ShowQuoteAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        if (start >= 0) {
             log.info("start>=0");
            result = catalogueService.getQuote(toi, start, rows);
        } else {
