 ...
 * @author Terry
 */
public class ShowQuoteItemsAction extends ActionSupport {
    ...
    public String execute() throws SQLException {
        ...
        count = catalogueService.getQuoteItemsByQuoteIdCount(templateId);
        if (count > 0) {
        ...
        if (start >= 0) {
            result = catalogueService.getQuoteItemsByQuoteId(templateId,start, rows, sidx, sord);
        } else {
