 ...
 * @author Terry
 */
public class ShowRolesAction extends ActionSupport {

    Logger log=Logger.getLogger(ShowRolesAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        log.info("id..."+id);
        count = administrationService.getRolesCountById(new Integer(id).intValue());
        ...
        if (start >= 0) {
            result = administrationService.getRolesById(new Integer(id).intValue(), start, rows, sidx, sord);
        } else {
