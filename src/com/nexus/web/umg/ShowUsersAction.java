...
public class ShowUsersAction extends ActionSupport {
     ...
     Logger log=Logger.getLogger(ShowUsersAction.class);
    private int page;
    private int rows;
    private String sidx;
    private String sord;
    ...
    public String execute() throws SQLException {
        ...
        log.info("id.."+id);
        count = administrationService.getAllUsersCountById(new Integer(id).intValue());
        ...
        if (start >= 0) {
            result = administrationService.getAllUsersById(new Integer(id).intValue(), start, rows, sidx, sord);
        } else {
