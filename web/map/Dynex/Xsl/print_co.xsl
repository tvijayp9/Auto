...
--&gt;</xsl:text>
				...
				<title>TradeRoute Change Order</title>
			</head>
			<body>- Organisation Identifier:
				<xsl:value-of select="EDXDATA/DOCDATA/TRADEROUTEVALUES/CREATOR_NAME"/>-
				<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/TempItemCoded/EDXBABLE/ORIGINATOR/VALUE"/>-
				<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/TempOrderResponseHeaderNote/EDXBABLE/ORIGINATOR/VALUE"/>
									...
									<tbody>
										<tr>
											...
											<td bgColor="#c0c0c0" width="50%" style="border-right: 1px solid; border-top: 1px solid" class="Hdrh">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/Name1/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
										<tr>
											...
											<td bgColor="#c0c0c0" width="50%" style="border-right: 1px solid" class="Hdrh">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderNumber/BuyerOrderNumber/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
										<tr>
											...
											<td bgColor="#c0c0c0" width="50%" style="border-right: 1px solid; border-bottom: medium none" class="Hdrh">
												<xsl:call-template name="format-date">
													<xsl:with-param name="date" select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderIssueDate/EDXBABLE/ORIGINATOR/VALUE"/>
												</xsl:call-template>
												<xsl:text>&#xA;</xsl:text>
											</td>
										</tr>
										<tr>
											<td bgColor="#c0c0c0" width="50%" style="border-left: 1px solid; border-bottom: medium none" class="Hdrc">Change Order :</td>
											<td bgColor="#c0c0c0" width="50%" style="border-right: 1px solid; border-bottom: medium none" class="Hdrh">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/Purpose/PurposeCoded/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="50%" style="border-right: 1px solid; border-top: medium none; border-left: medium none; border-bottom: medium none" class="Hdrc">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderReferences/AccountCode/Reference/RefNum/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
										<tr>
									...
									<tbody>
										...
										<tr>
											...
											<td width="76%" class="Hdrc">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/BuyerParty/Party/OrderContact/Contact/ContactName/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="76%" class="Hdrc">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/ListOfStructuredNote/StructuredNote/GeneralNote/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
	<tr>
											<td width="24%" class="Hdrc">General Note:</td>
											<td width="76%" class="Hdrc">
												<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderHeaderNote/EDXBABLE/ORIGINATOR/VALUE"/>
											</td>
										</tr>
									</tbody>
								</table>
...
<tr>
													<td width="100%" class="Hdrc" colSpan="2">
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/Name2/EDXBABLE/ORIGINATOR/VALUE"/>
													</td>
												</tr>
<tr>
													<td width="100%" class="Hdrc" colSpan="2">
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/Name3/EDXBABLE/ORIGINATOR/VALUE"/>
													</td>
												</tr>
												<tr>
													<td width="100%" class="Hdrc" colSpan="2">
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/Street/EDXBABLE/ORIGINATOR/VALUE"/>
													</td>
												</tr>
												<tr>
													<td width="100%" class="Hdrc" colSpan="2">
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/City/EDXBABLE/ORIGINATOR/VALUE"/>,
														<xsl:text><![CDATA[ ]]></xsl:text>
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/PostalCode/EDXBABLE/ORIGINATOR/VALUE"/>
													</td>
												</tr>
												<tr>
													<td width="100%" class="Hdrc" colSpan="2">
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/Region/RegionCodedOther/EDXBABLE/ORIGINATOR/VALUE"/>
													</td>
												</tr>
												<tr>
													<td width="100%" class="Hdrc" colSpan="2">
														<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/OrderParty/ShipToParty/Party/NameAddress/Country/CountryCodedOther/EDXBABLE/ORIGINATOR/VALUE"/>
													</td>
												</tr>
												<tr>
													<td width="24%" class="Hdrc">
												...
												<tr>
													...
													<td width="70%" class="Hdrh">
														<xsl:call-template name="format-date">
															<xsl:with-param name="date" select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderDetail/ListOfChangeOrderItemDetail/ChangeOrderItemDetail/ItemDetailChanges/ItemDetail/DeliveryDetail/ListOfScheduleLine/ScheduleLine/RequestedDeliveryDate/EDXBABLE/ORIGINATOR/VALUE"/>
														</xsl:call-template>
														<xsl:text>&#xA;</xsl:text>
													</td>
												</tr>
							...
							<td width="100%">
								<table cellSpacing="0" width="100%" border="1" borderColor="#111111" style="; border-collapse: collapse" cellPadding="3">
									<tbody>
										...
										<xsl:for-each select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderDetail/ListOfChangeOrderItemDetail/ChangeOrderItemDetail/ItemDetailChanges/ItemDetail">
											<tr>
												<td class="TblcSmall">
													<xsl:value-of select="../../ItemDetailChangeCoded/EDXBABLE/ORIGINATOR/VALUE"/>
													<br></br>
											...
											<tr>
												...
												<td bgColor="#e2e2e2" class="TblcSmall" colSpan="7">
													...
													<xsl:value-of select="BaseItemDetail/FinalRecipient/Party/NameAddress/Department/EDXBABLE/ORIGINATOR/VALUE"/>
													<br/>
									...
									<tbody>
										<tr>
											...
											<td align="right" width="50%" class="TblcSmall">
												<xsl:value-of select="format-number(EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderSummary/RevisedOrderSummary/OrderSummary/TotalAmount/MonetaryValue/MonetaryAmount/EDXBABLE/ORIGINATOR/VALUE, &quot;###,###.00&quot;)"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td width="100%">
												<table cellSpacing="0" width="100%" border="0" borderColor="#111111" style="; border-collapse: collapse" class="TblcSmall" cellPadding="3">
													<tbody>
<xsl:for-each select="EDXDATA/DOCDATA/BUSOBJ/ChangeOrder/ChangeOrderHeader/OrderHeaderChanges/OrderHeader/ListOfStructuredNote/StructuredNote">
															<tr>
																<td width="100%">
																	<xsl:value-of select="GeneralNote/EDXBABLE/ORIGINATOR/VALUE"/>
																</td>
															</tr>
														</xsl:for-each>
