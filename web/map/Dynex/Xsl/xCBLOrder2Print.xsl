			...
			<EDXDATA>
				<xsl:for-each select="DOCDATA">
					<DOCDATA DESTEMAIL="False" DESTDESC="Quadrem via Axis" DESTPRINT="False" DESTPATH="False" DESTFAX="False">
						...
						<xsl:attribute name="EDXSENDMETH">TRSPOPRINT_<xsl:value-of select="BUSOBJ/Order/OrderHeader/OrderReferences/AccountCode/Reference/RefNum/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
						</xsl:attribute>
						<xsl:for-each select="BUSOBJ/Order/OrderHeader">
							<SalesOrderHeader>
								...
								<CustomerPO FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
									<xsl:value-of select="OrderNumber/BuyerOrderNumber/EDXBABLE/ORIGINATOR/VALUE"/>
								</CustomerPO>
								<CustomerCode FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
								...
								<TransportMode FLength="50" FAlign="left">
									<xsl:value-of select="ListOfTransport/Transport/TransportMode/TransportModeCodedOther/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
								</TransportMode>
								<BuyLocation FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0"/>
								<RequiredDate FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
									<xsl:value-of select="OrderDates/RequestedDeliverByDate/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
								</RequiredDate>
								<CustomerPODate FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
									<xsl:value-of select="OrderIssueDate/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
								</CustomerPODate>
								<OverRideAddress FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">N</OverRideAddress>
								<OverRideAddressName FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
									<xsl:value-of select="OrderParty/ShipToParty/Party/NameAddress/Name1/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
								</OverRideAddressName>
								<OverRideAddressLine1 FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
								...
								<OverRideAddressLine2 FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
								...
								<OverRideAddressPostCode>
									<xsl:value-of select="OrderParty/ShipToParty/Party/NameAddress/PostalCode/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
								</OverRideAddressPostCode>
								<ShipLinesCompleted FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">N</ShipLinesCompleted>
								<CarrierCode FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0"/>
								<CurrencyCode FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
									<xsl:value-of select="OrderCurrency/Currency/CurrencyCoded/EDXBABLE/ORIGINATOR/VALUE"/>
								</CurrencyCode>
								<OverRideAddressName2 FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0"/>
								<Comment1 FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
									<xsl:value-of select="ListOfStructuredNote/StructuredNote/GeneralNote/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
								</Comment1>
								<Comment2TradeRouteSaleOrderNumber FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
						...
						<xsl:for-each select="BUSOBJ/Order/OrderDetail">
							<SalesOrderDetailS>
								<xsl:for-each select="ListOfItemDetail/ItemDetail">
									<DetailLine>
										<RecordTypeDetail FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">DETAIL</RecordTypeDetail>
										...
										<Item FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
										...
										<UnitPrice FType="numeric" FLength="50" FAlign="right" FTrim="right" FDecimal="2">
											<xsl:value-of select="PricingDetail/TotalValue/MonetaryValue/MonetaryAmount/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
										</UnitPrice>
										<Quantity FType="numeric" FLength="50" FAlign="right" FTrim="right" FDecimal="2">
											<xsl:value-of select="BaseItemDetail/TotalQuantity/Quantity/QuantityValue/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
										</Quantity>
										<DeliveryDate FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
										...
										<CustPoLineNumber FType="string" FLength="50" FAlign="left" FTrim="right" FDecimal="0">
...
<metaInformation>
<scenarios ><scenario default="yes" name="Scenario2" userelativepaths="yes" externalpreview="no" url="POAXIS2MSA_955550_20021218103019&#x2D;1.xml" htmlbaseurl="" processortype="internal" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/><scenario default="no" name="Scenario3" userelativepaths="yes" externalpreview="no" url="POAXIS2MSA_S00423_20021015101001&#x2D;1.xml" htmlbaseurl="" processortype="internal" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/></scenarios><MapperInfo srcSchemaPath="Full_order_schema_bablised_v1.xsd" srcSchemaRoot="EDXDATA" srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="xCBLOrder2Print.xsd" destSchemaRoot="EDXDATA" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/>
</metaInformation>
-->