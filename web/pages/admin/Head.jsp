    ...
    <s:i18n name="umg_logoHead">
        <ul>
         ...
         String act_value = mysection.getProperty("showmessagelist");%>
                <a href="<%=act_value%>.action" title="Messages" ><span class="oneWord"><s:text name="logoHead.transaction"/></span></a>
                <%}%>
            </li>
           
            <li>
                <% if (mysection.containsKey("ViewCategoriesProducts")) {
         String act_value = mysection.getProperty("ViewCategoriesProducts");%>
                <a href="<%=act_value%>.action" title="catalog"><span class="oneWord"><s:text name="logoHead.catalogue"/></span></a>
                <%}%>
            </li>
         ...
         String act_value = mysection.getProperty("admin");%>
                <a href="<%=act_value%>.action" title="Administration" class="activeTab"><span class="oneWord"><s:text name="logoHead.administration"/></span></a>
                <%}%>
            </li>
            <li>
         ...
         String act_value = mysection.getProperty("productmanagement");%>
                <a href="<%=act_value%>.action" title="Product Management"><span class="twoWords"><s:text name="logoHead.product"/><br/><s:text name="logoHead.management"/> 
                    </span></a>
                <%}%>
            </li>
        </ul>
