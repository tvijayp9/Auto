...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/createRole.js"></script>
    </head>
    <body>
        <div id="container">
            <div id="header">
            ...
            <div id="body-wrapadmin">
                <h4>1. Please input role name</h4>
                <s:form>
                    <s:textfield id="roleName" name="roleName" label="Role Name" size="30" maxlength="30"/>
                    <s:hidden id="tabs" name="tabs"/>
                </s:form>
                <br/>
                <h4>2. Please select functions for this role</h4>
                <table id="list" class="scroll" cellpadding="0" cellspacing="0"></table>
                <div id="pager" class="scroll" style="text-align:center;"></div>
                <input type="button" id="create" value="Create Role"/>    
            </div>
