...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/confirmFavouriteOrder.js"></script>
    ...
    <body>
        <div id="container">
            ...
            <div id="body-wrap">
                <s:form>
                    <s:hidden name ="favouriteOrderId"  value="%{favouriteOrderId}"></s:hidden>
                    <table width="100%">
                        <tr>
                            <td>
                                <table width="100%">
                        ...
                        <tr>
                            <td>
                                <table width="100%">
                                    <tr>
                                        <td width="100%"><b> Purchase Order Delivery Date :</b> &nbsp;&nbsp;&nbsp;&nbsp;<s:textfield id="orderDate" name ="orderDate"  size="10" value="%{orderDate}" theme="simple" readonly="true"></s:textfield>(DD/MM/YYYY) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B> Comment :</B> &nbsp;&nbsp;&nbsp;&nbsp;<s:textfield id="comment" name ="uname"  maxlength="40" size="30" value="%{uname}" theme="simple"></s:textfield></td>
                                    </tr>
                                </table>
                        </td></tr>
                        <tr>
                            <td>
                                <table width="95%">
                                    <tr>
                                        <td width="15%"><br/> <B>Product Code</B></td>
                                        <td width="20%"><br/> <B>GTIN</B></td>
                                        <td width="40%"><br/> <B>Product name</B></td>
                                        <td width="15%"><br/> <B>UOM</B></td>
                                        <td width="5%"><br/> <B>QTY</B></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div style="height: 175px; overflow:auto">
                                    <table width="95%">
                                        <s:iterator value="selectedFavouriteOrderItems">
                                            <tr>
                                                <td width="15%"><s:property value="productid"/></td>
                                                <td width="20%"><s:property value="gtin"/></td>
                                                <td width="40%"><s:property value="name"/></td>
                                                <td width="15%"><s:property value="uom"/></td>
                                                <td width="5%"><s:property value="qty"/>
                                                    <s:hidden name ="%{gtin}"  value="%{qty}"></s:hidden>
                                                </td>
                                            </tr>
                                        </s:iterator>
                                    </table>
