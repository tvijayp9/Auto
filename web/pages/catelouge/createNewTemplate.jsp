...
<html>
    <head>
        ...
        <title>Create New Favourite Order</title>
        ...
        <script type="text/javascript" src="javascript/createNewTemplate.js"></script>
    </head>
    <body>
                <%
            String supNexusId=session.getAttribute("supplierid").toString();
            //System.out.println("in createnewtemplate jsp supNexusID.."+supNexusId);
        ...
        <div id="container">
            ...
            <div id="body-wrap">
                <h1>Create New Favourite Order</h1>
                <s:form name="form">
                    <input type='hidden' name=supnexusid value="<%=supNexusId%>" />
                Favourite Order Name: <s:textfield id="templateName" name="templateName" theme="simple" maxlength="20"/>
                ...
                <p>2. Please select products and <input type="button" id="add" value="Add"/> them into favourite order</p>
                <table id="list" class="scroll" cellpadding="0" cellspacing="0"></table>
                <div id="pager" class="scroll" style="text-align:center;"></div>
                <p>3. Please check your favourite order</p>
                <input type="button" id="delete" value="Delete Items"/>
                <table id="template" class="scroll" cellpadding="0" cellspacing="0"></table>
