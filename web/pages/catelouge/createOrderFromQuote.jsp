...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/createOrderFromQuote.js"></script>
    </head>
    <body>
        <div id="container">
            <div id="header">
            ...
            <div id="body-wrap">
                <table width="100%">
                    <tr>
                        <td width="100%"><b>This is order Confirmation page. You have selected the following items please verfiy and create order.</b></td>
                    </tr>
                </table>
                <s:form>
                    <table width="100%">
                            ...
                            <td>
                                <table width="95%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%"><br/><!--<input type="button" value="Confirm & Send & Add To Favourite orders" disabled="true"/>--></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
