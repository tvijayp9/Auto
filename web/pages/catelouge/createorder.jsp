...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/createorder.js"></script>
    </head>
    <body>
        <div id="container">
            <div id="header">
                ...
                <table  border="2" >
                    <thead>
                        ...
                        <tr valign="top" bgcolor="lightblue" align="center">
                            <th><br/><b>Your order has been created and sent to your supplier. If you want to check the order, please visit order history link.</b>
                            </th>
                        </tr>
                    </thead>
                </table>
