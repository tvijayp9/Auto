...
<html>
    <head>
        ...
        <title>Add as favourite order</title>
            ...
            <div id="body-wrap"> 
                <table  border="2" >
                    <thead>
                        <br/>
                        <tr valign="top">
                            <th><br/><b>The order has been created and sent to your supplier. If you want to check the order, please visit order history link.</b></th>
                        </tr>
                    </thead>
                    <tbody id ="offTblBdy">                        
                        <s:form theme="simple" method="post">
                            <s:hidden name ="orderNumber"  value="%{pono}"></s:hidden>
                            <tr><td><br/> <B>Please type in the display name for the favourite order.</B></td>
                                <td> <br/><s:textfield id="favouriteName" name ="favouriteName" size="30" maxlength="20"></s:textfield></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><br/><input type="button" value="Add To Favourite order" /></td>
                            </tr>
                        </s:form>
                    </tbody>                    
                </table>
