...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/favouriteorderlist.js"></script>
    ...
    <body>
        <div id="container">
            ...
            <div id="body-wrap">
                ...
                <input type="button" id="delete" value="Delete Favourite Orders"/>
                <input type="button" id="create" value="Create New Favourite Order"/>
