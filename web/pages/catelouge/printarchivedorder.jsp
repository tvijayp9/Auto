...
<html>
    ...
    <body>
        ...
        <h3>Supplier: <s:property value="supplierName"/></h3>
        <p>Purchase Order No: <span class="general"><s:property value="pono"/></span></p>
        ...
        <table cellspacing="0" id="playlistTable">
            ...
            <thead>
                <tr>
                    <th id="playlistPosHead" scope="col">Product Code</th>
