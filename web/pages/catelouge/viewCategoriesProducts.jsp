...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/viewCategoriesProducts.js?20200122194955"></script>
    ...
    <body>
        <%
            ...
            //System.out.println("in viewCategoriesProducts jsp supNexusID.."+supNexusId);
        ...
        <div id="container">
            ...
            <div id="body-wrap">
                ...
                <p>2. Please select products and <input type="button" id="add" value="Add"/> them into your shoppingcart</p>
                <table id="list" class="scroll" cellpadding="0" cellspacing="0"></table>
                <div id="pager" class="scroll" style="text-align:center;"></div>
                <p>3. Please check your shoppingcart</p>
