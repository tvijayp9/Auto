...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/viewShopping.js?version=2"></script>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="body-wrap">
                <h1>My Order</h1>
                <p>1. Please select products by using  <input type="button" id="scaniaCatalogue" value="Scania Catalogue"/>
				
				</p>
               <!--
                <div id="pager" class="scroll" style="text-align:center;"></div>
                <p>2. Please check your shoppingcart</p>
