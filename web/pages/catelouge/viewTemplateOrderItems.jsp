...
<html>
    <head>
        ...
        <title>Favourite Order Items</title>
        ...
        <script type="text/javascript" src="javascript/viewTemplateOrderItems.js"></script>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="body-wrap">
                <h1>Favourite Order Items</h1>
                <input type="button" id="delete" value="Delete Items"/>
                <input type="button" id="add" value="Add New Items"/>
                <input type="button" id="shoppingcart" value="Add Items To ShoppingCart"/>
