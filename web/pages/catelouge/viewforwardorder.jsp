...
<html>
    <head>
        ...
        <title>Future Order Details</title>
        ...
        <div id="container">
            ...
            <div id="body-wrap"> 
                ...
                <div style=" width: 900px; height: 150px;overflow:auto">
                    <table width = 95%>
                        <tbody >                            
                            <tr><td> <B>Purchase Order No : </B></td>
                                <td><s:property value="pono"/></td>
                                <td><input type="button" value="Print" /></td>
                            </tr>
                            <tr><td> <B>Order Delivery Date :</B></td>
                                <td><s:property value="orderDate"/></td>
                            </tr>
                            <tr>
                                <td><B>Status : </B></td>
                            ...
                            <s:else>
                            <tr>
                                <td><br/> <B>&nbsp;&nbsp;&nbsp;&nbsp<u>Product Code</u></B></td>
                                <th > <br/>&nbsp;&nbsp;&nbsp;&nbsp;<B><u>GTIN</u></B>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                <td><br/>&nbsp;&nbsp;&nbsp;&nbsp; <B><u>Product name</u></B>&nbsp;&nbsp;</td>
                                <td><br/> <B><u>UOM</u></B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td><br/><B><u>Quantity</u></B>&nbsp;</td>
                            </tr>
