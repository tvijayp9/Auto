...
<link href="css/reset.css" rel="stylesheet" type="text/css" media="all" />
        ...
        <script type="text/javascript">
           // var fromURL='<%=session.getAttribute("fromURL")%>';
		    var fromURL='https://ausdrill-test.coupahost.com/cxml/invoices';//test system
			//var fromURL='https://ausdrill.coupahost.com/cxml/invoices';//production system
...
<input type="hidden" name="cXML-base64" value = "<s:property value="invoiceCXML"/>" >




<input type="submit" value="Transfer Invoice To Coupa" id="submit1" /><br>
</form>
