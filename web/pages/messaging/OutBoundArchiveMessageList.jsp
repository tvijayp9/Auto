...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/outBoundArchiveMessageList.js"></script>
    ...
    <body>
        <div id="container">
            ...
            <div id="body-wrap1">
                <!--<input type="button" id="viewSelected" value="View Selected Orders"/>
                ...
                <s:form  theme="simple">
                <s:submit  theme="simple" action="ShowInBoundArchivelist" value="Retrieve Inbound Archived Transaction" />
                <s:submit id="outbound" theme="simple" action="ShowOutBoundArchivelist" value="Retrieve Outbound  Archived Transaction" />
                </s:form>
                <div id="mysearch"></div>
