...
<html>
    <head>
        ...
        <title>My OutBound Message List</title>
        ...
        <script type="text/javascript" src="javascript/outBoundMessageList.js"></script>
        <link href="css/OutBoundMessageList.css" rel="stylesheet" type="text/css"/>
