...
<html>
    <head>
        ...
        <script src="javascript/partnerlist.js" type="text/javascript"></script>
    </head>
    <body>
        <div id="container">
            <div id="header">
            ...
            <div id="body-wrap1">
                <table><tr><td><div id="mysearch"></div></td><td><input id="edit" type="button" value="Edit Partner"/></td></tr></table>
