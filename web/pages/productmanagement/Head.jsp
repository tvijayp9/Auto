    ...
    <s:i18n name="umg_logoHead">
        <ul>
         ...
         String act_value = mysection.getProperty("productmanagement");%>
                <a href="<%=act_value%>.action" title="Product Management" class="activeTab"><span class="twoWords"><s:text name="logoHead.product"/><br/><s:text name="logoHead.management"/></span></a>
                <%}%>
            </li>
        </ul>
    </s:i18n>
