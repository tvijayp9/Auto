    ...
    <s:i18n name="umg_logoHead">
        <ul>
         ...
         String act_value = mysection.getProperty("showpartnerlist");%>
                ...
                <span class="twoWords" ><s:text name="logoHead.trading"/><br /><s:text name="logoHead.partner"/></span></a>
                <%} %>
            </li>
		 ...
		 %>
                <a href="<%=act_value%>.action" title="Data Resolution"  class="activeTab"><span class="twoWords"><s:text name="logoHead.data"/><br /><s:text name="logoHead.resolution"/></span></a>
                <%}
                %>
            </li>
        </ul>
