...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/userPartners.js"></script>
    </head>
    <body>
        <div id="container">
            <div id="header">
            ...
            <div id="body-wrapadmin">
                ...
                <table border="0">
                    <tr>
                        <td colspan="2"><h4>1. Select the user from below drop down box</h4>
                            <br/>
							<s:form>
							    <s:textfield id="loginId" name="loginId" label="User Name" size="30" maxlength="30"/>
                                <s:hidden id="userId" name="userId"/>
                                <s:hidden id="moreUsers" name="moreUsers"/>
                                <s:hidden id="existingUsers" name="existingUsers"/>
                            </s:form>
                        <br/></td>
                    </tr>
                    <tr>
                        <td><h4>2. Your can delete existing partners below for this user</h4>
                            <table id="list" class="scroll" cellpadding="0" cellspacing="0"></table>
                            <div id="pager2" class="scroll" style="text-align:center;"></div>
                        <br/></td>
                        <td><h4>3. You can add more partners below for this user</h4>
                            <table id="list2" class="scroll" cellpadding="0" cellspacing="0"></table>
                            <div id="pager" class="scroll" style="text-align:center;"></div>
                        <br/></td>
                    </tr>
                    <tr>
                        <td colspan="2"><h4>4. Save all of modifications by clicking <input type="button" id="assign" value="Save"/></h4></td>
                    </tr>
                </table>
            </div>
            <div id="footer">
