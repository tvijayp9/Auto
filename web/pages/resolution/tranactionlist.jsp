...
<html>
    <head>
        ...
        <script src="javascript/transactionlist.js" type="text/javascript"></script>
        <style type="text/css">
<!--
#mysearch {
	float: left;
...
-->
    ...
    <body>
        <div id="container">
			...
			<div id="body-wrap3">
				<s:form name="form">
					<div id="mysearch"></div><input type="submit" id="tobeprocessed" value="have not been processed" />
					<input type="submit" id="processed" value="have been Accepted/Rejected" />
				</s:form>
			</div>
            <div id="body-wrap1">
