...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
       ...
       <div id="container">
             <div id="header">
                <img src="images/homepage/nexus-logo.jpg"/>
                <img   align="top" src="images/homepage/xml-yes-logo.jpg"/>&nbsp;</td>
            </div>
            <div id="main">
                <s:actionerror/>
                <div id="level1">
                    <div id="leftlevel">
                        ...
                        <s:form action="login" method="post">
                            <s:hidden name="errorlogin" value="xmlyes" />
                    ...
                    <div id="rightlevel">
                        ...
                        <p><a href="http://www.xmlyes.com">Home/Site Map</a></p>
            ...
            <div id="footer">
                © Dealer Name  ABN 51 055 566 595  Dealer Address
            </div>
        </div>
    </body>
</html>