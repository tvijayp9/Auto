									...
									<table cellSpacing="0" width="100%" border="1" borderColor="#111111" style="; border-collapse: collapse" cellPadding="3">
										<tbody>
											...
											<tr>
												...
												<td align="right" class="TblcSmall">
													<xsl:value-of select="EDXDATA/DOCDATA/BUSOBJ/Invoice/InvoiceSummary/InvoiceTotals/ChargeTotal/MonetaryValue/MonetaryAmount/EDXBABLE/DESTINATION/RESOLVEDVALUE"/>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<table cellSpacing="0" align="right" border="1" borderColor="#111111" style="; border-collapse: collapse" cellPadding="3">
									<tbody>
										<tr>
											...
											<xsl:choose>
												<xsl:when test="number($value)">
													...
													<td align="right" width="50%" class="TblcSmall">$ <xsl:value-of select="$value"/>											
													</td>
														</xsl:when>
												<xsl:otherwise>
													<td align="left" width="50%" class="TblhSmall">
													 ReStocking Fee	(0 %)</td>
													<td align="right" width="50%" class="TblcSmall">$ 0.00</td>
												</xsl:otherwise>
										</xsl:choose>
										...
										<tr>
											...
											<td align="right" width="50%" class="TblcSmall">$ <xsl:value-of select="format-number(EDXDATA/DOCDATA/BUSOBJ/Invoice/InvoiceSummary/InvoiceTotals/NetValue/MonetaryValue/MonetaryAmount/EDXBABLE/DESTINATION/RESOLVEDVALUE, &quot;###,###.00&quot;)"/>
											</td>
										</tr>
										<tr>
											<td align="left" width="50%" class="TblhSmall">Total GST</td>
											<td align="right" width="50%" class="TblcSmall">$ <xsl:value-of select="format-number(EDXDATA/DOCDATA/BUSOBJ/Invoice/InvoiceSummary/InvoiceTotals/TotalTaxAmount/MonetaryValue/MonetaryAmount/EDXBABLE/DESTINATION/RESOLVEDVALUE, &quot;###,###.00&quot;)"/>
											</td>
										</tr>
										<tr bgColor="#c0c0c0">
											<td align="left" width="50%" class="TblhSmall">Total</td>
											<td align="right" width="50%" class="TblcSmall">$ <xsl:value-of select="format-number(EDXDATA/DOCDATA/BUSOBJ/Invoice/InvoiceSummary/InvoiceTotals/GrossValue/MonetaryValue/MonetaryAmount/EDXBABLE/DESTINATION/RESOLVEDVALUE, &quot;###,###.00&quot;)"/>
											</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										...
										<tr>
											...
											<td width="50%" align="right">
												<font size="5" face="bold">COPY PRINT</font>
											</td>
										</tr>
									</tbody>
								</table>
